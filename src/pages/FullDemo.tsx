...
export function FullDemo() {
  ...
  const handleShortcut = (shortcut: string, currentValue: string) => {
    ...
    switch (shortcut) {
      case 'selectAll':
        // In a real implementation, you would select all text in the textarea
        // For demo purposes, we'll just log it
        alert('Select All (Ctrl+A) triggered! This would select all text in a real text editor.');
        break;
      case 'copy':
        alert('Copy (Ctrl+C) triggered! Text copied to clipboard.');
        break;
      case 'paste':
        alert('Paste (Ctrl+V) triggered! This would paste from clipboard.');
        break;
      case 'undo':
        alert('Undo (Ctrl+Z) triggered! This would undo the last action.');
        break;
      case 'redo':
        alert('Redo (Ctrl+Y) triggered! This would redo the last undone action.');
        break;
    }
  };
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <ul className="text-blue-600 dark:text-blue-300 space-y-1 text-sm">
                  ...
                  <li>• <strong>Long-press Backspace</strong> to delete continuously</li>
                  <li>• <strong>Ctrl+A</strong> - Select all text</li>
                  <li>• <strong>Ctrl+C</strong> - Copy text to clipboard</li>
                  <li>• <strong>Ctrl+V</strong> - Paste from clipboard</li>
                  ...
                  <li>• Modifier keys highlight when active</li>
